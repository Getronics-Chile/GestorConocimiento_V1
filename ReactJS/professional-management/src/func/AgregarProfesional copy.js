    ...
    <div>
      ...
      >
        ...
        <div className="col-md-4">
          ...
          <select
            className="form-control"
            value={newHabilidad.estadoProfesional}
            onChange={(e) => setNewHabilidad({ ...newHabilidad, estadoProfesional: e.target.value })}
          >
            <option value="">Seleccionar estado</option>
            <option value="Avanzado">Activo</option>
            <option value="Medio">Inactivo</option>
          </select>
        </div>
        ...
        <div className="col-md-4">
          ...
          <input
            type="text"
            className="form-control"
            value={newProfessional.nacionalidad}
            onChange={(e) =>
              setNewProfessional({
                ...newProfessional,
        ...
        <div className="col-md-4">
          ...
          <input
            type="text"
            className="form-control"
            value={newProfessional.perfilProfesional}
            onChange={(e) =>
              setNewProfessional({
                ...newProfessional,
                perfilProfesional: e.target.value
              })
            }
          />
        </div>
          ...
          <div className="card shadow-lg rounded">
            ...
            <div className="card-body">
              <ul>
                ...
                <li>
                  <strong>Estado profesional:</strong> {professionalSummary.estadoProfesional}
                </li>
                <li>
